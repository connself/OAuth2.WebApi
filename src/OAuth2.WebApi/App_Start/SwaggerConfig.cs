...
namespace OAuth2.WebApi
{
    ...
    {
        //https://github.com/yinboxie/Swagger-Demo
            ...
            config.EnableSwagger(c =>
                    {
                        ...
                        //
                        c.SingleApiVersion("v1", "OAuth2.WebApi");
                        ...
                        c.IncludeXmlComments($@"{System.AppDomain.CurrentDomain.BaseDirectory}\bin\OAuth2.WebApi.XML");
                ...
                .EnableSwaggerUi("documents/{*assetPath}", c =>
                    {
